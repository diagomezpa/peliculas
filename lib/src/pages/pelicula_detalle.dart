...
class PeliculaDetalle extends StatelessWidget {
    ...
    return Scaffold(
      body:CustomScrollView(
        slivers: <Widget>[
          ...
          SliverList(// que acepte un arreeglo de de widgets que no sean slivers
 ...
 Widget _crearAppbar(Pelicula pelicula) {
  ...
  Widget _crearCasting( Pelicula pelicula) {
      ...
      return FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<List> snapshot) {
          if(snapshot.hasData){
            //print(snapshot.data);
            return _crearAtoresPageView(snapshot.data);
          }else{
  ...
  Widget _crearAtoresPageView(List <Actor> actores) {
